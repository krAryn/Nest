...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <div className={`sidebar md:min-w-[280px] w-60 xl:w-72 bg-white border-r border-gray-200 flex flex-col justify-between item-center max-sm:absolute top-0 bottom-0 z-20 ${sidebarOpen? "translate-x-0": "max-sm:-translate-x-full"} transition-all ease-in-out`}>
